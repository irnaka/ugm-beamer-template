...
\newcommand{\hrefcol}[2]{\textcolor{ugmteal}{\href{#1}{#2}}}
...
\title{Get started with the UGM Beamer Theme}
\titlebackground{images/ugm_aerial.png}
% an asterisk will split the background:
% \titlebackground*{images/ugm_aerial.png}
\subtitle{Using \LaTeX\ to prepare slides}

\author{\href{mailto:marwan.irnaka@ugm.ac.id}{T. Marwan Irnaka}}
\date{\today}

\begin{document}

\footlinecolor{ugmyellow}
\maketitle

% default is no footline, but page numbers are incredibly useful for the audience to ask questions later
\footlinecolor{ugmblue}

\section{Introduction}

\begin{frame}{Beamer for UGM presentations}
...
\section{Pokok bahasan pertama}

\begin{chapter}[images/ugm_merapi.jpg]{ugmblue}{Pokok bahasan pertama}
...
{images/ugm_merapi_eruption.pdf}
\end{verbatim}
\end{block}
...
\end{column}
\begin{column}{0.7\textwidth}
\begin{colorblock}[black]{ugmteal}{Color Blocks}
...
\small
\begin{verbatim}
\begin{colorblock}[black]{ugmteal}{title}
content...
\end{colorblock}
\end{verbatim}
\end{colorblock}
...
\begin{sidepic}{images/ugm_arsip.png}{Side-Picture Slides}
...
\begin{chapter}[images/ugm_fkkmk.jpg]{ugmblue}{Personalization}
...
\begin{itemize}
    \item We are currently using \testcolor{ugmblue} color for our footer.
...
\item \textrm{Serif} vs \textsf{Sans-Serif} fonts
  ...
  \item \textbf{Gama Sans} and \textbf{Gama Serif} have been provided with this template.
  \item To conveniently switch from Gama Sans to Gama Serif, please use \verb|\usefonttheme{serif}| in the preamble.
    \begin{itemize}
...
\end{itemize}
UGM signature font is Gama Sans and Gama Serif.
\begin{itemize}
\item A copy of Gama Sans and Gama Serif can be obtained \hrefcol{https://www.ffonts.net/Gama-Sans-Regular.font.download}{here}.
\end{itemize}
\end{frame}
...
\item The colors are defined in the \texttt{ugmcolor} package, in accordance with the \hrefcol{https://brand.ugm.ac.id/brand-guideline/}{UGM Brand Guideline}:
  \begin{itemize}
  \item UGM's primary colors are PANTONE P111-16C (\testcolor{ugmblue}) and PANTONE P7-8C (\testcolor{ugmyellow}).
  \item UGM's secondary colors are Chicago Blue (\testcolor{chicagoblue}), UI Health Teal (\testcolor{ugmteal}) and Champions Gold (\testcolor{championsgold}).
  \item UGM's neutral colors are Expo White (\testcolor{expowhite}) and Steel Gray (\testcolor{steelgray} or \testcolor{steelgrey}).
  \end{itemize}
...
\begin{chapter}[images/ugm_gsp.jpg]{ugmblue}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}

\begin{chapter}[images/ugm_gate.jpg]{ugmblue}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}
...
\begin{chapter}[images/ugm_gate.jpg]{ugmyellow}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}

\begin{chapter}[images/ugm_gate.jpg]{steelgray}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}
\themecolor{light}
...
\begin{itemize}
\item Download your logo from \hrefcol{https://brand.ugm.ac.id/brand-guideline/}{here}.
    \begin{itemize}
...
\item Manually overlay it on a static color background using an SVG editor.
    \begin{itemize}
    \item You can look at \verb|ugmcolor.sty| file for the numerical value of the UGM background colors.
    \end{itemize}
...
\begin{itemize}
\item This template is based on UIC template which is hosted on GitHub
    \begin{itemize}
    \item  \verb|https://github.com/irnaka/ugm-beamer-template|
...
\hrefcol{mailto:marwan.irnaka@ugm.ac.id}{send them to me!}
\end{itemize}
\end{frame}
